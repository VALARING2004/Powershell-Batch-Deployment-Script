# Claw — Windows 企业批量部署自动化方案

<p align="center">
  <strong>并行安装引擎 · 系统优化 · 更新控制 · 一键部署</strong>
</p>
...
Claw 是一套 **基于 PowerShell 的 Windows 企业级批量部署自动化框架**，通过并行安装引擎实现 **12 款常用软件的并发静默安装**，同步完成隐私加固、广告屏蔽、性能优化等 22 项系统配置。
